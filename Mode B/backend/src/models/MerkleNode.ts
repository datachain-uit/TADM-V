...
/*
 * ONC dat tien to `onchain_` cho MOI collection, de khong bao gio
 * ghi de du lieu cua nhanh off-chain — hai nhanh dung chung mot
 * MongoDB. Xem CLAUDE.md muc "Repository layout".
 */
const MerkleNode =
    mongoose.models.OnchainMerkleNode
    ||
    mongoose.model(
        "OnchainMerkleNode",
        MerkleNodeSchema,
        "onchain_merkle_nodes"
    );
